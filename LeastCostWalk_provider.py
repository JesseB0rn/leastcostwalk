...
from .LeastCostWalk_algorithm import LeastCostWalkAlgorithm


class LeastCostWalkProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(LeastCostWalkAlgorithm())
